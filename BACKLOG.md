...
### BUG-00 — WAIT-сигналы навсегда остаются PENDING
...
### KISS-02 — WS инициализация и переключение повторяются 3 раза
...
### KISS-03 — exchange/index.js: 5 функций с одинаковым if/else паттерном
...
### KISS-04 — Расчёт SL/TP цен дублируется в Dashboard и SignalModal
...
### KISS-05 — Settings.jsx: saveBybitKeys повторяет testConnection
...
### KISS-06 — Нормализация сигналов на фронтенде вместо бэкенда
...
### KISS-07 — Повторяющиеся useEffect-паттерны загрузки в Stats
...
### KISS-08 — PnL-расчёт в tracker.js: дублированная формула
...
### KISS-10 — SettingRow паттерн повторяется 4+ раза в Settings
...
### KISS-11 — calculateDelta повторяется в инициализации и onWsMessage
